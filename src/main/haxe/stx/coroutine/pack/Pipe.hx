...
typedef PipeDef<I,O,E> = CoroutineSum<I,O,Noise,E>;

@:using(stx.coroutine.pack.Pipe.PipeLift)
@:forward abstract Pipe<I,O,E>(PipeDef<I,O,E>) from PipeDef<I,O,E> to PipeDef<I,O,E>{
  ...
  @:from static public function fromCoroutine<I,O,E>(self:Coroutine<I,O,Noise,E>):Pipe<I,O,E>{
    return lift(self);
  }
}
class PipeLift{
